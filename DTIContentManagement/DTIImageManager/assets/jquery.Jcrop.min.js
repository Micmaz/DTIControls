...
function setHiddenField(c){
    if (c.w && c.h)
        $("#myCropper").parent().find("input[type=hidden]").val(coorinatesArray(c));
    else
        $("#myCropper").parent().find("input[type=hidden]").val("");
}
