...
<div class="Control_Holder" runat="server" id="pnlGalleryHolder">
        ...
        <cc2:FreezeIt runat="server" ID="freezePanel" DisplayOnAnyPostback="false" UseCentering="true"><asp:Image runat="server" ID="imgWait" ImageUrl="~/res/BaseClasses/Scripts.aspx?f=DTIGallery/defaultWait.gif" /></cc2:FreezeIt>
        ...
        <div class="Gallery_Button_Div" id="Gallery_Button_Div" runat="server" style="display:none;">
            <asp:ImageButton ID="btnGalleryFirst" CssClass="First_Button" runat="server"  ImageUrl="~/res/BaseClasses/Scripts.aspx?f=DTIGallery/gallery_first.png"/>
            <asp:ImageButton id="btnGalleryBack" cssclass="Back_Button" runat="server" ImageUrl="~/res/BaseClasses/Scripts.aspx?f=DTIGallery/gallery_back.png"  />
            ...
            <asp:ImageButton ID="btnGalleryPage" CssClass="Page_Button" runat="server" style="display:none;" ImageUrl="~/res/BaseClasses/Scripts.aspx?f=DTIGallery/gallery_go.png" />
            <asp:ImageButton id="btnGalleryFwd" cssclass="Forward_Button" runat="server" ImageUrl="~/res/BaseClasses/Scripts.aspx?f=DTIGallery/gallery_fwd.png"  />
            <asp:ImageButton ID="btnGalleryLast" CssClass="Last_Button" runat="server" ImageUrl="~/res/BaseClasses/Scripts.aspx?f=DTIGallery/gallery_last.png"  />
        </div>
</div>
