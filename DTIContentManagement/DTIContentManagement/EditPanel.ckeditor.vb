...
#Region "Properties"
    ...
    Private WithEvents _htmlEdit As ckEditor.ckEditor
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("The text contained in the html editor.")> _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("Show save and cancel buttons.")> _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("Readonly property with the contents data table for all editors on this page.")> _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("DataRow for the current content.")> _
...
#Region "Events"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("Saves the current instance and makes all other editors obn the page to be saved on pre-render.")> _
    ...
    ''' </summary>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("Saves just the current instance of the editor")> _
...
#Region "Helper Functions"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("The html editor instance.")> _
    Public Function htmlEdit() As ckEditor.ckEditor
        If _htmlEdit Is Nothing Then
            _htmlEdit = New ckEditor.ckEditor
    ...
    ''' </summary>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("SQL call information")> _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("Sets the contents row of the data objects.")> _
    ...
    ''' </summary>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("Sets the text of the datarow to the text value of the control.")> _
    ...
    ''' </summary>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("Saves the contents of the control.")> _
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <System.ComponentModel.Description("Changes the sizes of any dynamic images in the string to the size on the html page so the image size is the same as it appears to the client.")> _
    ...
    Private Sub registerVideos()
        If Text.Contains("ViewVideoScreenShot.aspx?insertvideo") Then
            ...
            Dim vidDivRegex As Regex = New Regex( _
                  "<img[\x00-\x7E]*?ViewVideoScreenShot\.aspx\?insertvideo[\x00-\x7E]*?>", _
    ...
    Private Sub setuphtmleditor()
        ...
        dlg2.Name = "history"
        dlg2.IconPath = "~/DTIContentManagement/reload.gif"
        dlg2.DialogTitle = "History Tool"
        ...
        dlg2.IframeURL = "~/res/DTIContentManagement/History.aspx"
        ...
        If htmlEdit.Page Is Nothing Then
            Me.Controls.Add(htmlEdit)
        End If
        htmlEdit.addIframeDialog(dlg2)

        Dim dlg As New ckEditor.IframeDialog()
        dlg.Name = "uploader"
        dlg.IconPath = "~/DTIContentManagement/raster_add.gif"
        dlg.DialogTitle = "Media Uploader"
        'dlg.IframeURL = "~/res/DTIContentManagement/MediaList.aspx"
        dlg.IframeURL = mediaListURL
        dlg.DialogHeight = 580
        dlg.DialogWidth = 720
        dlg.ToolTip = "Upload Media..."
        'htmlEdit.Toolbar.Add("uploader")
        htmlEdit.addIframeDialog(dlg)

        'htmlEdit.myManager.useLastActiveEditor = False

        'htmlEdit.ToolbarMode = ckEditor.ckEditor.ToolbarModes.PageTop
