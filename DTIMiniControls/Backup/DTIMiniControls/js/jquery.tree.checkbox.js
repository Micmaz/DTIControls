	...
	$.extend($.tree.plugins, {
		"checkbox" : {
			...
			check : function (n) {
				...
				if(opts.three_state) {
				    if(opts.check_children) n.find("li").andSelf().children("a").removeClass("unchecked undetermined").addClass("checked");
				    else n.children("a").removeClass("unchecked undetermined").addClass("checked");
			...
			uncheck : function (n) {
				...
				if(opts.three_state) {
				    ...
				    else n.children("a").removeClass("checked undetermined").addClass("unchecked");
				}
