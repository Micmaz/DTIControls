...
#End Region
        ...
        Private Sub ImageCropper_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            End If
            jQueryLibrary.jQueryInclude.addScriptFile(Me.Page, "DTIMiniControls/jquery.Jcrop.css", "text/css", True)
            jQueryLibrary.jQueryInclude.addScriptFile(Me.Page, "DTIMiniControls/jquery.Jcrop.min.js", , True)
        End Sub
    ...
    End Function
        ...
        Private Function myInsertScript() As String
            Return "<script type=""text/javascript"">" & vbCrLf & _
                ...
                "        jQuery('#" & Me.ClientID & "').Jcrop({" & vbCrLf & _
                "            onSelect: " & OnSelectFunctionName & "," & _
                "            bgColor: '" & Me.bgColor & "'," & vbCrLf & _
                "            bgOpacity: " & Me.bgOpacityString & _
                Me.setSelectString & vbCrLf & _
                Me.setMaxSizeString & vbCrLf & _
                Me.setMinSizeString & vbCrLf & _
                Me.aspectRatioString & vbCrLf & _
                "        });" & vbCrLf & _
                "    });" & vbCrLf & _
                "</script>"
        End Function
