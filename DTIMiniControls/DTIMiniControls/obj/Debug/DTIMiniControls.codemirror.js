...
var CodeMirror = (function() {
  ...
  CodeMirror.getMIME = function(mime) {
    return mimeModes[mime];
  };
  
  //var currentmode;
  //CodeMirror.getCurrentMode() = function(){
  //  return currentmode;
  //};
  ...
  CodeMirror.getMode = function(options, spec) {
    ...
    if (!mfactory) {
	  ...
	  currentmode = CodeMirror.getMode(options, "text/plain");
    } else {
	  currentmode = mfactory(options, config || {});
	}
    return currentmode;
  };
