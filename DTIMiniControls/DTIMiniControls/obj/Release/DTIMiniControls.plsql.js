...
(function() {
  ...
  var cKeywords = "abort accept access add all alter and any array arraylen as asc assert assign at attributes audit " +
        ...
        "connected constant constraint crash cross create current currval cursor " +
        ...
        "object of off offline on online only open option or order out outer " +
        ...
        "returning reverse revoke right rollback row rowid rowlabel rownum rows run " +
