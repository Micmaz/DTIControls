...
#End If
            ...
            Public Shared Sub Register(ByRef page As Page, Optional ByVal addAtPosition As Integer = 4, Optional ByVal asWebResource As Boolean = False)
                ...
                Dim jQueryIncludeHeader As query = BaseClasses.Spider.spiderPageforType(page, GetType(query))
                If jQueryIncludeHeader Is Nothing Then
                    If Not asWebResource Then
                        page.Header.Controls.AddAt(addAtPosition, New query("text/javascript", "jquery.query.js"))
                    Else
                        Dim scriptLocation1 As String = page.ClientScript.GetWebResourceUrl(GetType(query), "jQueryLibrary.jquery.query.js")
                        page.Header.Controls.AddAt(addAtPosition, New query("text/javascript", scriptLocation1, True))
                    End If
                End If
            End Sub
            ...
            ''' <remarks></remarks>
            <System.ComponentModel.Description("Constructor for query class")> _
