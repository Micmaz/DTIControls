...
#End If
    ...
    Protected Overrides Sub Render(ByVal writer As System.Web.UI.HtmlTextWriter)
        ...
        Me.ScriptText = _
            "SummerNote.plugins.add('" & Name & "',{" & vbCrLf & _
            vbTab & "icons: '" & Name & "'," & vbCrLf & _
            vbTab & "init:function(a){" & vbCrLf & _
            vbTab & vbTab & "SummerNote.dialog.addIframe('" & Name & "_dialog', '" & DialogTitle & "','" & IframeURL & "'," & DialogWidth & "," & DialogHeight & ",function(){/*oniframeload*/})" & vbCrLf & _
        ...
        Me.ScriptText &= vbTab & "SummerNote.currentInstance.openDialog('" & Name & "_dialog');" & vbCrLf
        ...
        Me.ScriptText &= _
        "SummerNote.config.extraPlugins += '" & Name & ",';"
