          ...
          '<div class="form-group">'+
            ...
            '<div class="input-group col-xs-9">'+
              '<select id="note-video-attributes-size" class="note-video-attributes-size form-control col-xs-6">'+
                ...
                '<option value="5">'+lang.videoAttributes.videoOption5+'</option>'+
              '</select>'+
            '</div>'+
          '</div>'+
          '<div class="form-group">'+
      ...
      this.show=function(){
        ...
        this.showLinkDialog(vidInfo)
          .then(function(vidInfo){
            ...
            if($videoSize.val()==5)var videoWidth='320',videoHeight='180';
            ...
            if($videoSize.val()==0)$video.addClass('embed-responsive');else $videoHTML.css({'float':$videoAlignment.val(),'margin':'5px'});
