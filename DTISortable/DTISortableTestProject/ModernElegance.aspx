<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ModernElegance.aspx.vb" Inherits="DTISortableTestProject.ModernElegance" %>
	...
	<div id="content">
		...
		<div class="main" style="background:url(ModernEleganceColors/brown/replaceableImage.gif) no-repeat 0 0;background-position:right top">
            ...
            test Panel 2 bla de bla bah muhahahaha <asp:Button ID="Button2" runat="server" Text="Button" />--%>
             <cc1:EditPanel ID="EditPanel1" contentType="asdfasdf2" runat="server">
             Test Adding Edit Panel on modern elegance
             </cc1:EditPanel>            
         </cc2:DTISortable>
				<%--<cc2:DTISortable ID="DTISortableServer1" runat="server" contentType="News" HandleText="Drag Me">
				</cc2:DTISortable>--%>
			</div>
			<div class="right">
				
				<div class="news">
					<%--<cc2:DTISortable ID="DTISortableServer2" runat="server" contentType="aboutUs" HandleText="Drag Me">
					</cc2:DTISortable>--%>
				</div>
			</div>
			<div class="cl">&nbsp;</div>
...
<%--		<cc2:DTISortable ID="DTISortableServer3" CssClass="sidebar" runat="server" contentType="Hours" HandleText="Drag Me">
...
<div style="position:fixed; width:180px; left:5px; top:5px; z-index:1000;">
<%--<cc2:DTIWidgetMenuServer ID="Menu1" runat="server" HandleText="Drag Me"/>--%>
            <%--<cc2:DTIRecycleBin ID="Recycle1" runat="server" NumberOfItems="5" HandleText="Drag Me"/>--%></div>
