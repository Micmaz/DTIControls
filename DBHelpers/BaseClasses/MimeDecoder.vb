...
#End If
	...
	''' <returns></returns>
	''' <remarks></remarks>
	<System.ComponentModel.Description("REturns the mime type for a file extension.")>
	Public Shared Function MimeType(ByVal strFileExt As String) As String
		If strFileExt.Contains("?") Then
			strFileExt = strFileExt.Substring(0, strFileExt.IndexOf("?"))
		End If
