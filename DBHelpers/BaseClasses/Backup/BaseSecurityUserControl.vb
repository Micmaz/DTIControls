...
''' </summary>
''' <remarks></remarks>
<System.ComponentModel.Description("Base class for System.Web.UI.UserControl class, adding data accessors, error handeling and basic security.")> _
Public Class BaseSecurityUserControl
    Inherits UserControl
    Private Const classname As String = "BaseClasses.BaseSecurityUserControl"
    ...
    Public ReadOnly Property Data() As BaseClasses.DataBase
        Get
            ...
            If Session("DataObj." & currBaseDataType.FullName) Is Nothing Then
                ...
                'Moved to sqlhelper property in dataBase class
                'If Not WebConfigurationManager.ConnectionStrings("ConnectionString") Is Nothing Then
                '    Dim constr As String = WebConfigurationManager.ConnectionStrings("ConnectionString").ConnectionString
                ...
                '    data1.defaultConnection = New SqlClient.SqlConnection(constr)
                'End If
            End If
