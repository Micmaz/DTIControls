...
#End If
    ...
    ''' <remarks></remarks>
        ...
        Private ReadOnly Property filename() As String
            Get
                Try
                Dim fname As String = Request.QueryString.Item("f")
                If fname.LastIndexOf("f=") > -1 Then
                    fname = fname.Substring(fname.LastIndexOf("f=") + 2)
                End If
                fname = fname.Substring(fname.LastIndexOf("~") + 1)
                If fname.IndexOf("/res/") > -1 Then
                    Return fname.Replace("/res/", "")
                ElseIf fname.IndexOf("res/") > -1 Then
                    Return fname.Replace("res/", "")
                ElseIf fname.IndexOf("/") = 0 Then
...
#End If
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
        <System.ComponentModel.Description("Handles the init event of the page. Will end the responce if the item is unmodified and therefore uses the client cache.")> _
