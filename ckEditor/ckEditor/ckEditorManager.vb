...
''' <summary>
''' manager class for keeping multiple ckEditor instances on one page.
''' </summary>
''' <remarks></remarks>
#If DEBUG Then
...
#End If
    ...
    Private Sub ckEditorManager_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub setScript()
        ...
        ElseIf ActiveEditor IsNot Nothing Then
            ...
            str &= "});" & vbCrLf
        End If
        'str &= "CKEDITOR.config.extraPlugins = '';" & vbCrLf

        'Me.script.ScriptText = str
    End Sub
